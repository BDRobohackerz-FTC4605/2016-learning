...
@TeleOp(name="Simplified Demo Teleop", group="Demo")  // @Autonomous(...) is the other common choice
//@Disabled

public class SimplifiedDemoTeleop extends OpMode {
	...
	public void loop() {
		...
		right = scaleMotor(right);
		left =  scaleMotor(left);
		...
		/*
		 * Driver 2
		 * Climber flip arm, hang lock, and debris ramp, lift, and sweeper
		 */
