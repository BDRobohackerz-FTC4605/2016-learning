...
@Autonomous(name="EXP - Auto Beacon Tip", group="Autonomous")  // @Autonomous(...) is the other common choice
//@Disabled

public class AutoBeaconTip extends LinearOpMode {

	/*
	 * Robohackerz FTC 4605
	 * 2/14/2016
	 *
	 * An autonomous for tipping th climbers into the beacon
	 */
	...
	public void runOpMode() throws InterruptedException {
		...
		//Move to pivot point
		inchMove(0.5, -55.5, 1120);
		sleep(500);
		turn(90 * turnMult, -1 * turnMult);
		sleep(500);
		inchMove(0.5, -45, 1120);
		sleep(1000);
